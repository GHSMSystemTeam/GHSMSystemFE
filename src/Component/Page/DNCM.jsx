      ...
      <main className="flex-grow">
        <div className="bg-gradient-to-r from-purple-100 to-blue-50 py-16">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl font-bold text-center text-purple-700 mb-4">Đội Ngũ Chuyên Môn</h1>
            <p className="text-lg text-center text-gray-700 mb-12 max-w-3xl mx-auto">
              Đội ngũ chuyên môn của Trung tâm Y học Giới tính TPHCM gồm các chuyên gia đầu ngành 
              trong lĩnh vực Y học Giới tính, Nam học, Phụ khoa và Tâm lý học với nhiều năm kinh nghiệm 
              trong chẩn đoán, tư vấn và điều trị các vấn đề liên quan đến sức khỏe tình dục và giới tính.
            </p>
